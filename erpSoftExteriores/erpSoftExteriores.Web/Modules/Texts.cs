    ...
    public static partial class Texts
    {
        ...
        public static class Forms
        {
            public static class Membership
            {
                ...
                {
                    public static LocalText EmailSubject = "Reset Your erpSoftExteriores Password";
                ...
                {
                    public static LocalText ActivateEmailSubject = "Activate Your erpSoftExteriores Account";
                    ...
                    public static LocalText FormTitle = "Sign up for erpSoftExteriores";
        ...
        public static class Navigation
        {
            ...
            public static LocalText SiteTitle = "erpSoftExteriores";
        }

      /*  public static class MantenimientoGeneral
        {
            public static class DivisionesAdministrativas
            {
                public static LocalText N1 = "Provincia";
                public static LocalText N2 = "Cantón";
                public static LocalText N3 = "Distrito";
                public static LocalText N4 = "--Nivel Superior--";
                public static LocalText N5 = "--Nivel Superior--";
            }
        }
        */
            ...
            public static class Site
        {
            ...
            public static class RegistroColumnas
            {
                public const string CreadoPor = "Creado por";
                public const string ModificadoPor = "Modificado por";
                public const string CreadoEl = "Fecha de creación ";
                public const string ModificadoEl = "Fecha modificado";
            }
            ...
            {
                public static LocalText FooterCopyright = "Copyright (c) 2016.";
                public static LocalText FooterInfo = "ErpSoft Exteriores";
                public static LocalText FooterRights = "Todos los derechos reservados.";
