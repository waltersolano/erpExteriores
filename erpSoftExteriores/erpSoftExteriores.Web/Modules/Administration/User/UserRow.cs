...
namespace erpSoftExteriores.Administration.Entities
{
    ...
    public sealed class UserRow : LoggingRow, IIdRow, INameRow, IIsActiveRow
    {
        ...
        [DisplayName("Password"), Size(50), SetFieldFlags(FieldFlags.NotMapped)]
        ...
        [DisplayName("Confirm Password"), Size(50), SetFieldFlags(FieldFlags.NotMapped)]
