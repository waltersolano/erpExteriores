...
namespace MVC
{
    public static class Views
    {
        ...
        public static class Common
        {
            ...
            {
                public const string StandardReport = "~/Modules/Common/Reporting/StandardReport.cshtml";
            }
        }
        ...
        {
            public static class GenDivisionesAdministrativasN1
            {
                public const string GenDivisionesAdministrativasN1Index = "~/Modules/General/GenDivisionesAdministrativasN1/GenDivisionesAdministrativasN1Index.cshtml";
            }

            public static class GenDivisionesAdministrativasN2
            {
                public const string GenDivisionesAdministrativasN2Index = "~/Modules/General/GenDivisionesAdministrativasN2/GenDivisionesAdministrativasN2Index.cshtml";
            }

            public static class GenDivisionesAdministrativasN3
            {
                public const string GenDivisionesAdministrativasN3Index = "~/Modules/General/GenDivisionesAdministrativasN3/GenDivisionesAdministrativasN3Index.cshtml";
            }

            public static class GenDivisionesAdministrativasN4
            {
                public const string GenDivisionesAdministrativasN4Index = "~/Modules/General/GenDivisionesAdministrativasN4/GenDivisionesAdministrativasN4Index.cshtml";
            }

            public static class GenDivisionesAdministrativasN5
            {
                public const string GenDivisionesAdministrativasN5Index = "~/Modules/General/GenDivisionesAdministrativasN5/GenDivisionesAdministrativasN5Index.cshtml";
            }

            public static class GenMonedas
            {
                public const string GenMonedasIndex = "~/Modules/General/GenMonedas/GenMonedasIndex.cshtml";
            }

            public static class GenRutas
            {
                public const string GenRutasIndex = "~/Modules/General/GenRutas/GenRutasIndex.cshtml";
            }

            public static class GenTipoIdentificacion
            {
                public const string GenTipoIdentificacionIndex = "~/Modules/General/GenTipoIdentificacion/GenTipoIdentificacionIndex.cshtml";
            }

            public static class GenTipoPago
            {
                public const string GenTipoPagoIndex = "~/Modules/General/GenTipoPago/GenTipoPagoIndex.cshtml";
            }
        ...
        {
            public static class InvArrendadores
            {
                public const string InvArrendadoresIndex = "~/Modules/Inventario/InvArrendadores/InvArrendadoresIndex.cshtml";
            }

            public static class InvArrendadoresContactos
            {
                public const string InvArrendadoresContactosIndex = "~/Modules/Inventario/InvArrendadoresContactos/InvArrendadoresContactosIndex.cshtml";
            }

            public static class InvCategoriasSoporteEstructura
            {
                public const string InvCategoriasSoporteEstructuraIndex = "~/Modules/Inventario/InvCategoriasSoporteEstructura/InvCategoriasSoporteEstructuraIndex.cshtml";
            }

            public static class InvProductos
            {
                public const string InvProductosIndex = "~/Modules/Inventario/InvProductos/InvProductosIndex.cshtml";
            }

            public static class InvProductosLegal
            {
                public const string InvProductosLegalIndex = "~/Modules/Inventario/InvProductosLegal/InvProductosLegalIndex.cshtml";
            }

            public static class InvSitios
            {
                public const string InvSitiosIndex = "~/Modules/Inventario/InvSitios/InvSitiosIndex.cshtml";
            }

            public static class InvSitiosContratosArrendamiento
            {
                public const string InvSitiosContratosArrendamientoIndex = "~/Modules/Inventario/InvSitiosContratosArrendamiento/InvSitiosContratosArrendamientoIndex.cshtml";
            }

            public static class InvStatus
            {
                public const string InvStatusIndex = "~/Modules/Inventario/InvStatus/InvStatusIndex.cshtml";
            }

            public static class InvTiposEstructura
            {
                public const string InvTiposEstructuraIndex = "~/Modules/Inventario/InvTiposEstructura/InvTiposEstructuraIndex.cshtml";
            }
        ...
        {
            public static class LogRegistroSimple
            {
                public const string LogRegistroSimpleIndex = "~/Modules/Logs/LogRegistroSimple/LogRegistroSimpleIndex.cshtml";
            }
