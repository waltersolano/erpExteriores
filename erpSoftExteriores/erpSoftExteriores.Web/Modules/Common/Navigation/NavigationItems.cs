...
using Northwind = erpSoftExteriores.Northwind.Pages;
using Administration = erpSoftExteriores.Administration.Pages;
using Basic = erpSoftExteriores.BasicSamples.Pages;
using Inventario = erpSoftExteriores.Inventario.Pages;
using General = erpSoftExteriores.General.Pages;


[assembly: NavigationLink(100, "Dashboard", url: "~/", permission: "", icon: "icon-speedometer")]

/*GENERAL*/
[assembly: NavigationMenu(1000, "General", icon: "icon-anchor")]
[assembly: NavigationMenu(1001, "General/Divisiones Administrativas")]
[assembly: NavigationLink(1002, "General/Divisiones Administrativas/Nivel 1", typeof(General.GenDivisionesAdministrativasN1Controller))]
[assembly: NavigationLink(1003, "General/Divisiones Administrativas/Nivel 2", typeof(General.GenDivisionesAdministrativasN2Controller))]
[assembly: NavigationLink(1005, "General/Divisiones Administrativas/Nivel 3", typeof(General.GenDivisionesAdministrativasN3Controller))]
[assembly: NavigationLink(1006, "General/Divisiones Administrativas/Nivel 4", typeof(General.GenDivisionesAdministrativasN4Controller))]
[assembly: NavigationLink(1007, "General/Divisiones Administrativas/Nivel 5", typeof(General.GenDivisionesAdministrativasN5Controller))]

[assembly: NavigationLink(1100, "General/Monedas", typeof(General.GenMonedasController))]
[assembly: NavigationLink(1200, "General/Rutas", typeof(General.GenRutasController))]
[assembly: NavigationLink(1300, "General/Tipo de Identificación", typeof(General.GenTipoIdentificacionController))]
[assembly: NavigationLink(1400, "General/Tipo de Pago", typeof(General.GenTipoPagoController))]



[assembly: NavigationMenu(2000, "Inventario", icon: "glyphicon glyphicon-list-alt")]

[assembly: NavigationMenu(2050, "Inventario/Arrendadores")]
[assembly: NavigationLink(2060, "Inventario/Arrendadores/Arrendadores", typeof(Inventario.InvArrendadoresController))]
[assembly: NavigationLink(2070, "Inventario/Arrendadores/Contactos", typeof(Inventario.InvArrendadoresContactosController))]


[assembly: NavigationMenu(2050, "Inventario/Estructuras")]
[assembly: NavigationLink(2010, "Inventario/Estructuras/Tipos", typeof(Inventario.InvTiposEstructuraController))]
[assembly: NavigationLink(2050, "Inventario/Estructuras/Categorias", typeof(Inventario.InvCategoriasSoporteEstructuraController))]

[assembly: NavigationLink(2060, "Inventario/Status", typeof(Inventario.InvStatusController))]

[assembly: NavigationMenu(2040, "Inventario/Productos")]
[assembly: NavigationLink(2040, "Inventario/Productos/Productos", typeof(Inventario.InvProductosController))]
[assembly: NavigationLink(2040, "Inventario/Productos/Información Legal", typeof(Inventario.InvProductosLegalController))]


[assembly: NavigationMenu(2050, "Inventario/Sitios")]
[assembly: NavigationLink(2030, "Inventario/Sitios/Sitios", typeof(Inventario.InvSitiosController))]
[assembly: NavigationLink(2020, "Inventario/Sitios/Contratos", typeof(Inventario.InvSitiosContratosArrendamientoController))]
...
[assembly: NavigationMenu(2000, "Administration", icon: "icon-screen-desktop")]
[assembly: NavigationLink(2100, "Administration/Languages", typeof(Administration.LanguageController), icon: "icon-bubbles")]
[assembly: NavigationLink(2200, "Administration/Translations", typeof(Administration.TranslationController), icon: "icon-speech")]
[assembly: NavigationLink(2300, "Administration/Roles", typeof(Administration.RoleController), icon: "icon-lock")]
[assembly: NavigationLink(2400, "Administration/User Management", typeof(Administration.UserController), icon: "icon-people")]
