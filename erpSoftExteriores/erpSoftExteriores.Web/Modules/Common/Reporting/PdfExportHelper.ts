        ...
        export function exportToPdf(options: PdfExportOptions): void {
            ...
            Q.serviceCall({
                ...
                onSuccess: response => {
                    ...
                    srcColumns.splice(Q.indexOf(srcColumns, x => x.cssClass == "grid-view-button"), 1);
                    srcColumns.splice(Q.indexOf(srcColumns, x => x.cssClass == "grid-edit-button"), 1);
                    ...
                    let reportTitle = options.reportTitle || g.getTitle() || "Reporte";
