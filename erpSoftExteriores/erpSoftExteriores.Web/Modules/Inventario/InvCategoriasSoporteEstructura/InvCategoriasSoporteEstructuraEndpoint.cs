...
namespace erpSoftExteriores.Inventario.Endpoints
{
    ...
    using MyRepository = Repositories.InvCategoriasSoporteEstructuraRepository;
    using MyRow = Entities.InvCategoriasSoporteEstructuraRow;

    [RoutePrefix("Services/Inventario/InvCategoriasSoporteEstructura"), Route("{action}")]
    [ConnectionKey("Default"), ServiceAuthorize("AdministracionDeInventario")]
    public class InvCategoriasSoporteEstructuraController : ServiceEndpoint
    {
        /******/
        public FileContentResult ListExcel(IDbConnection connection, ListRequest request)
        {
            var columns = typeof(Columns.InvArrendadoresColumns);
            var name = "Categorias Estructuras_";
