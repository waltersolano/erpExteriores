...
namespace erpSoftExteriores.Inventario.Endpoints
{
    ...
    using MyRepository = Repositories.InvTiposEstructuraRepository;
    using MyRow = Entities.InvTiposEstructuraRow;

    [RoutePrefix("Services/Inventario/InvTiposEstructura"), Route("{action}")]
    [ConnectionKey("Default"), ServiceAuthorize("AdministracionDeInventario")]
    public class InvTiposEstructuraController : ServiceEndpoint
    {
        /******/
        public FileContentResult ListExcel(IDbConnection connection, ListRequest request)
        {
            var columns = typeof(Columns.InvTiposEstructuraColumns);
            var name = "TiposEstructuras_";
