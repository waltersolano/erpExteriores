...
namespace erpSoftExteriores.Inventario.Endpoints
{
    ...
    using MyRepository = Repositories.InvStatusRepository;
    using MyRow = Entities.InvStatusRow;

    [RoutePrefix("Services/Inventario/InvStatus"), Route("{action}")]
    [ConnectionKey("Default"), ServiceAuthorize("AdministracionDeInventario")]
    public class InvStatusController : ServiceEndpoint
    {
        /******/
